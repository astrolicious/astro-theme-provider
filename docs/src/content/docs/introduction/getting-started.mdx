...
1. Clone the [theme template](https://github.com/astrolicious/astro-theme-template)

	```sh
	git clone https://github.com/astrolicious/astro-theme-template.git my-theme
	```
