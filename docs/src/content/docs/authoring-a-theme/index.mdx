...
description: How to author a theme using Astro Theme Provider
sidebar:
  hidden: true
---
...
By default, any Styles inside the `styles` folder at the root of your package will be included in the `/styles` module
