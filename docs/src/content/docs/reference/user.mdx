...
This type for this property depends on the theme, typically themes will use an object. The value must be JSON serializable.
...
Example of how a blog theme might be configured
